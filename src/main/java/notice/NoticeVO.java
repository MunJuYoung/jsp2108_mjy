...
public class NoticeVO {
	...
	public String toString() {
		return "NoticeVO [idx=" + idx + ", nickName=" + nickName + ", title=" + title + ", content=" + content
				+ ", wDate=" + wDate + ", readNum=" + readNum + ", hostIp=" + hostIp + ", mid=" + mid + ", wCdate="
				+ wCdate + ", wNdate=" + wNdate + ", preIdx=" + preIdx + ", nextIdx=" + nextIdx + ", preTitle="
