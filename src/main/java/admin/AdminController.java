...
public class AdminController extends HttpServlet{
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else if(com.equals("/adMemberInfo")) {
			command = new AdMemberInfoCommand();
			command.execute(request, response);
			viewPage += "/adMemberInfo.jsp";
		}
		else if(com.equals("/adProductReg")) {
			viewPage += "/adProductReg.jsp";
		}
		else if(com.equals("/duplicationCheck")) {
			command = new DuplicationCheckCommand();
			command.execute(request, response);
			viewPage += "/duplicationCheck.jsp";
		}
		else if(com.equals("/adProductRegOk")) {
			command = new AdProductRegOkCommand();
			command.execute(request, response);
			viewPage = "/WEB-INF/message/message.jsp";
		}
