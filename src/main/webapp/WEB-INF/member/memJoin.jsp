...
<%@ include file="/include/bs4.jsp"%>
 ...
 <script src="${ctp}/daumApi/woo.js"></script>
 <script>
 	var idCheckOn = 0;
 	var idValid = 0;
 	var nickCheckOn = 0;
 	...
 	function idCheck() {
 		...
 		var url = "${ctp}/idCheck.mem?mid="+mid;
 		...
 		if(mid==""){
 			...
 			idCheckOn = 1;
    	window.open(url,"아이디 중복체크","width=500px,height=250px");
 		}
 	}
 ...
 // 닉네임 중복체크
  function nickCheck() {
  	...
  	var url = "${ctp}/nickCheck.mem?nickName="+nickName;
  	...
  	if(nickName=="") {
  		...
  		nickCheckOn = 1;
  		window.open(url,"닉네임 중복체크","width=500px,height=250px");
  	}
  }
...
<!-- 네비 -->
	...
	<div class="container" style="padding:30px">
		<form name="myform" method="post" action="${ctp}/memJoinOk.mem" enctype="Multipart/form-data">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="mid" onkeyup="idReset()" placeholder="영문자로 시작하는 영문자 혹은 숫자 4~12자" name="mid" onchange="idFunc()" required autofocus/>
    ...
    <div class="form-group">
      ...
      <input type="password" class="form-control" id="pwdConfirm" placeholder="비밀번호를 다시 입력해주세요" name="pwdConfirm" maxlength="12" onchange="pwdConfirmCheck()" required/>
