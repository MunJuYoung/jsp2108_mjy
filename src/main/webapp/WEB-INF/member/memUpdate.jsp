...
<div class="container" style="padding:30px">
  <form name="myform" method="post" action="${ctp}/memUpdateOk.mem" enctype="multipart/form-data" class="was-validated">
    <h2>회 원 정 보 수 정</h2>
    <br/>
    ...
    <div class="form-group">
      ...
      <input type="password" class="form-control" id="pwd" placeholder="비밀번호를 입력하세요." name="pwd" maxlength="12" required/>    </div>
    <div class="form-group">
...
<%		} %>
    ...
    <div  class="form-group">
      회원 사진(파일용량:2MByte이내) : <a href="${ctp}/data/member/<%=vo.getPhoto()%>" target="_blank"><img src="${ctp}/data/member/<%=vo.getPhoto()%>" width="80px"/></a>
